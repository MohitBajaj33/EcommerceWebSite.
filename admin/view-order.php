                                    ...
                                    <div class="col-md-6">
                                                        ...
                                                        foreach($order_query_run as $items)
                                                        {
                                                            ...
                                                            <tr>
                                                                <td class="align-middle">
                                                                    <img src="../uploads/<?= $items['image']?>" alt="<?= $items['name']?>" width="50px">
                                                                </td>
                                                                <td class="align-middle">
                                                                <?= $items['price']?>
                                                                </td >
                                        ...
                                        <div class="mb-3">
                                            <form action="code.php" method="POST">
                                                ...
                                                <button type="submit" name="update_order_btn" class="btn btn-primary mt-2">Udate Status</button>
                                           </form>
                                        </div>
                                    </div>
                                </div>
